...
- `npx storybook@latest automigrate --config-dir packages/common-react/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir apps/dashboard/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir packages/common-angular/.storybook --renderer @storybook/angular`
